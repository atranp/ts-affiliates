...
function SidebarNavLink({
  ...
  const partnerActive = variant === "partner" && active;
  return (
    <Link
      href={item.href}
      onClick={onNavigate}
      ...
      <div className="border-t border-border/60 p-3">
        ...
        {variant === "partner" && (
          <Link
            ...
            onClick={onNavigate}
            className={cn(
              "mb-1 flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-medium transition-colors",
  ...
  return (
    <div className="min-h-[100dvh] bg-background pt-[var(--impersonation-offset,0px)]">
      ...
      <div className="flex min-h-0 lg:h-[calc(100dvh-var(--impersonation-offset,0px))]">
        ...
        <aside className="hidden w-60 shrink-0 border-r border-border/60 bg-card shadow-sm lg:fixed lg:bottom-0 lg:left-0 lg:top-[var(--impersonation-offset,0px)] lg:z-30 lg:flex lg:flex-col">
        ...
        <div className="flex min-h-0 min-w-0 max-w-full flex-1 flex-col lg:pl-60">
          {/* Mobile top bar */}
          <header className="sticky top-0 z-40 flex h-14 items-center gap-3 border-b border-border/60 bg-card/95 px-4 shadow-xs backdrop-blur-md lg:hidden">
            <button
              type="button"
          ...
          <main
            className={cn(
              "flex min-h-0 min-w-0 max-w-full flex-1 flex-col px-4 py-5 pb-[max(2rem,env(safe-area-inset-bottom))] sm:px-6 sm:py-6 lg:overflow-x-hidden lg:overscroll-contain lg:px-8 lg:py-7 lg:pb-10",
              variant === "partner"
